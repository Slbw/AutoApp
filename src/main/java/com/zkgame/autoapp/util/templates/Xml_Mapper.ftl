...
<mapper namespace="com.zkgame.autoapp.dao.mapper.${modelName}Mapper" >
  <resultMap id="BaseResultMap" type="com.zkgame.autoapp.model.${modelName}" >
  ...
  <!-- 新增记录 -->
  <insert id="insert" parameterType="com.zkgame.autoapp.model.${modelName}" useGeneratedKeys="true" keyProperty="id">
  ...
  <!-- 新增记录 -->
  <insert id="insertSelective" parameterType="com.zkgame.autoapp.model.${modelName}" useGeneratedKeys="true" keyProperty="id">
    insert into ${tableName}
  ...
  <!-- 修改指定记录 -->
  <update id="updateByPrimaryKeySelective" parameterType="com.zkgame.autoapp.model.${modelName}" >
    update ${tableName}
    <set>
    	<#list fields as field>
  ...
  <!-- 修改指定记录 -->
  <update id="updateByPrimaryKey" parameterType="com.zkgame.autoapp.model.${modelName}" >
    update ${tableName}
    set 
	    <#list fields as field>
