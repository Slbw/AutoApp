...
import com.zkgame.autoapp.service.codeGenerator.IGeneratorService;
...
//	private static final Logger logger = Logger.getLogger(GeneratorServiceImpl.class);
	...
	protected String templatesDir = workspace + "src/main/java/com/zkgame/autoapp/util/templates";
